...
it is used to let clients depend on stable internal or predefined interfaces, avoiding modifications and allowing interactions between incompatible objects.<br>
...
the bridge pattern decouples abstractions from implementors so that they can vary independently.<br>
