...
natural numbers (`N`): non fractional numbers greater than `0`.<br>
whole numbers (`W`): non fractional numbers greater than or equal to `0`.<br>
...
irrational numbers (`P`): real & not rational numbers.<br>
